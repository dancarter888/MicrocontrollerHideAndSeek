# File:   Makefile
# Author: Ann Ngo, Daniel Siemers
# Date:   12 Oct 2019
# Descr:  Makefile for game hide and seek
# Status: 	Incompleted
...
game.o: foursquare.c ../../drivers/avr/ir_uart.h ../../drivers/avr/system.h ../../drivers/display.h ../../drivers/navswitch.h ../../utils/font.h ../../utils/pacer.h ../../utils/tinygl.h run.h
	$(CC) -c $(CFLAGS) $< -o $@
...
.PHONY: program
program: game.hex
	dfu-programmer atmega32u2 erase; dfu-programmer atmega32u2 flash foursquare.hex; dfu-programmer atmega32u2 start